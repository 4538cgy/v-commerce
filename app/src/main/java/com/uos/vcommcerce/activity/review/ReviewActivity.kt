...
class ReviewActivity : AppCompatActivity() {
    ...
    inner class ReviewRecyclerViewAdapter() : RecyclerView.Adapter<ReviewRecyclerViewAdapter.ReviewRecyclerViewAdapterViewHolder>(){
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReviewRecyclerViewAdapter.ReviewRecyclerViewAdapterViewHolder {

            val binding = ItemReviewItemBinding.inflate(LayoutInflater.from(binding.root.context),parent,false)
